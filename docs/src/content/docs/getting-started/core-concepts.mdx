...
The `Validator` class is the heart of Valicomb. You create an instance with your data and configure rules:
...
Use dot notation to validate nested arrays:
...
- [Defining Rules](/guides/defining-rules/) - Master rule definition syntaxes
- [Custom Rules](/guides/custom-rules/) - Create your own validation rules
